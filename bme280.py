...
class BME280(object):
    def __init__(self, i2c_bus, i2c_address):
        ...
        #					Normal mode
        self.bus.write_byte_data(self.i2c_address, 0xF4, 0x27)
        # BME280 address, 0x76(118)
        # Select Configuration register, 0xF5(245)
        #		0xA0(00)	Stand_by time = 1000 ms
        self.bus.write_byte_data(self.i2c_address, 0xF5, 0xA0)
    ...
    def read(self):
        ...
        var_H = (adc_h - (self.dig_H4 * 64.0 + self.dig_H5 / 16384.0 * var_H)) * (
                    self.dig_H2 / 65536.0 * (1.0 + self.dig_H6 / 67108864.0 * var_H * (1.0 + self.dig_H3 / 67108864.0 * var_H)))
        ...
        logger.info("Temperature in Celsius : %.2f C" % cTemp)
        logger.info("Temperature in Fahrenheit : %.2f F" % fTemp)
        logger.info("Pressure : %.2f hPa " % pressure)
